...
class TestBase_to_json_string(unittest.TestCase):
    ...
    def test_to_json_string_rectangle_type(self):
        ...
        self.assertEqual(str, type(Base.to_json_string([p.to_dictionary()])))

    def test_to_json_string_rectangle_one_dict(self):
        p = Rectangle(10, 7, 2, 8, 6)
        self.assertTrue(len(Base.to_json_string([p.to_dictionary()])) == 53)

    def test_to_json_string_rectangle_two_dicts(self):
        p1 = Rectangle(2, 3, 5, 19, 2)
        p2 = Rectangle(4, 2, 4, 1, 12)
        list_dicts = [p1.to_dictionary(), p2.to_dictionary()]
